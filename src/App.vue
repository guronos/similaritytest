...
export const received = reactive({
    testingPhase : '',
    clickInputCode :false,
    clickBeginTesting : false,
    showWelcomeBlock: true,
    resultInReferalCodeForFemale : '',
    resultVariable : ''
})
import Navigation from './conteiners/NavigationApp/';
export default {
...
<style>
@import url('https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,700;1,800&display=swap');
